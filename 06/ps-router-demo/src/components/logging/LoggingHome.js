...
/*
LoggingLink is a custom Link. LoggingRoute is a custom route.
eid in ${match.url}/lorem/:eid is an event id.
*/

// Decompose props.match
        ...
        <div>
            ...
            <h4>
                <LoggingLink
                    to={`${
                        match.url
                    }/lorem/7fd2a0f4-29ea-4650-803a-67418b597090`}
                >
                    Link 1
                </LoggingLink>
                {' | '}
                <LoggingLink
                    to={`${
                        match.url
                    }/lorem/1842a9f0-449d-499f-bd19-36106da591fa`}
                >
                    Link 2
                </LoggingLink>
            </h4>
